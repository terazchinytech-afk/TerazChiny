...
export const HeroSection = ({ data }: HeroSectionProps) => {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      timeoutId = setTimeout(() => setWindowWidth(window.innerWidth), 100); // 100ms opóźnienia
    };
      ...
      <div className="absolute top-0 -z-10 grid h-208.75 w-screen grid-cols-[5fr_4fr] overflow-hidden max-[900px]:flex max-[900px]:flex-col max-[900px]:h-auto">
        <div className="relative z-20 h-full w-full bg-brand-red max-[900px]:h-157.5">
          <Image
            ...
            quality={60}
            fetchPriority="high"
            sizes="(max-width: 640px) 100vw, (max-width: 1024px) 100vw, 50vw" // Na desktopie zajmuje ok połowy ekranu (5fr z 9fr)
            placeholder="blur" // Dodaj to, jeśli masz wygenerowany blurDataURL (opcjonalnie)
            blurDataURL="data:image/png;base64,"
          />
        </div>

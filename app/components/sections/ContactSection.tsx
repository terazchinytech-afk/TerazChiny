...
export const ContactSection = ({ data }: ContactSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10 max-[440px]:max-w-full max-[440px]:w-full max-[440]: ps-0 pe-0">
        <div className="relative w-full min-h-[600px] rounded-[40px] overflow-hidden shadow-2xl">
          {/* Zdjęcie główne z Sanity (lub fallback) */}
          <Image
            src={heroImage || "/contactImage.png"}
            fill
            alt="Podróż do Chin"
              ...
              <div className="flex flex-col gap-6 w-full">
                ...
                {contactCard?.email && (
                  ...
                  >
                    ...
                    <ArrowUpRight
                      size={18}
                      className="ml-auto text-gray-300 group-hover:text-brand-red transition-colors"
                    />
                  </Link>
                )}
